...
//
//Create a fourth variable named totalGoals (javascript, C#, Java) or total_goals (python, ruby). totalGoals/total_goals should
//store the sum of all of Messi's goals for this year.


public class MessiGoalTotal {
